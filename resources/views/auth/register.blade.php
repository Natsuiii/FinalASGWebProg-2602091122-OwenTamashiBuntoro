                                ...
                                <div class="m-sm-4">
                                    <form action="{{ route('auth.register') }}" method="POST">
                                            ...
                                            <select class="form-select @error('hobby') is-invalid @enderror"
                                                ...
                                                @foreach ($hobbies as $hobby)
                                                    <option value="{{ $hobby->id }}"
                                                        {{ collect(old('hobby'))->contains($hobby->id) ? 'selected' : '' }}>
                                                        {{ $hobby->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('hobby')
                                        ...
                                        <div class="mb-3 input-group">
                                            ...
                                            <input type="text"
                                                class="form-control form-control-lg @error('instagram') is-invalid @enderror" value="{{ old('instagram') }}"
                                                placeholder="Enter your instagram username" name="instagram" id="instagram">
                                            @error('phone')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
